      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Link href="/productos" passHref legacyBehavior><Nav.Link>Productos</Nav.Link></Link>
            <Link href="/contacto" passHref legacyBehavior><Nav.Link>Contacto</Nav.Link></Link>
          </Nav>
          <Nav>
