...
const Header = () => {
  ...
  return (
    <Navbar expand="lg" sticky="top" style={{ backgroundColor: '#1b4332' }} variant="dark">
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav>
            <Nav.Link href="mailto:otherelec75@yahoo.com" className="text-white me-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
            </Nav.Link>
            <Nav.Link href="https://wa.me/573164827994" target="_blank" rel="noopener noreferrer" className="text-white">
