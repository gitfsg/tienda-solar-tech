...
const Header = () => {
  ...
  return (
    <Navbar expand="lg" sticky="top" style={{ backgroundColor: '#90ee90' }} variant="light">
      <Container>
        <Navbar.Brand as={Link} href="/">
          <Image src="/ElectronikSer LOGO sombreado y recESTE1.jpg" width={150} height={40} alt="Tienda Solar" />
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link as={Link} href="/" className="text-white">Inicio</Nav.Link>
            <Nav.Link as={Link} href="/productos" className="text-white">Productos</Nav.Link>
            <Nav.Link as={Link} href="/contacto" className="text-white">Contacto</Nav.Link>
          </Nav>
          <Nav>
            <Nav.Link as={Link} href="/contacto" className="text-white me-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ cursor: 'pointer' }}><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
            </Nav.Link>
            <Nav.Link href="https://wa.me/573046073273" target="_blank" rel="noopener noreferrer" className="text-white">
            ...
            <Nav.Link as={Link} href="/carrito" className="text-white">
              Carrito <Badge bg="light" text="dark">{itemCount}</Badge>
            </Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
