...
const Footer = () => {
  return (
    <footer className="mt-5 p-4 text-center" style={{ backgroundColor: '#90ee90', color: '#1b4332' }}>
      <Container>
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
          <p className="mb-3 mb-md-0">&copy; {new Date().getFullYear()} Tienda Solar y Tecnológica. Todos los derechos reservados.</p>
          
          <div className="d-flex flex-column align-items-start align-items-md-center">
            <Link
              href="/contacto"
              className="mb-2 d-inline-block"
              style={{ textDecoration: 'none', lineHeight: 0, color: '#1b4332' }}>
            ...
            <a href="https://wa.me/573046073273" target="_blank" rel="noopener noreferrer" style={{ color: '#1b4332' }}>
